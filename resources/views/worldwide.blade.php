<x-layout>
    <x-panel name='worldwide' title="{{ __('worldwide.panel_title') }}">
        <div class='mt-6 lg:md-10 grid grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5'>
            <div class='flex justify-center items-center col-span-2 lg:col-span-1 w-full'>
                <div
                    class='w-full h-64 aspect-w-3 aspect-h-4 bg-blue-700 bg-opacity-10 flex flex-col py-8 lg:py-10 px-8 items-center rounded-2xl justify-center lg:px-20 gap-4 min-w-24'>
            ...
            <div class='flex justify-center items-center'>
                ...
                <div
                    class='h-64 w-full aspect-w-3 aspect-h-4 bg-green-500 bg-opacity-10 flex flex-col py-8 lg:py-10 px-8 items-center rounded-2xl justify-center lg:px-20 gap-4 min-w-24'>
            ...
            <div class='flex justify-center items-center'>
                ...
                <div
                    class='h-64 w-full aspect-w-3 aspect-h-4 bg-yellow-400 bg-opacity-10 flex flex-col py-8 px-8 lg:py-10 items-center rounded-2xl justify-center lg:px-20 gap-4 min-w-24'>

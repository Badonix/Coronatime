        ...
        <div class='mt-6 lg:md-10 grid grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-5'>
            <div class='flex justify-center items-center col-span-2 lg:col-span-1 w-full'>
                <div
                    ...
                    <div class='flex flex-1 flex-col items-center gap-2'>
                        <p class='font-medium text-base lg:text-xl'>New cases</p>
            ...
            <div class='flex justify-center items-center'>
                ...
                <div
                    ...
                    <div class='flex flex-col items-center gap-2'>
                        <p class='font-medium text-base lg:text-xl'>Recovered</p>
            ...
            <div class='flex justify-center items-center'>
                ...
                <div
                    ...
                    <div class='flex flex-col items-center gap-2'>
                        <p class='font-medium text-base lg:text-xl'>Death</p>
